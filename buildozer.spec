...
requirements = python3==3.11.5, hostpython3==3.11.5, fastapi==0.99.1, starlette, typing-extensions, passlib, uvicorn, jinja2, pydantic==1.10.15, anyio, sniffio, idna, click, h11, python-multipart
