...
requirements = python3, fastapi, starlette, typing-extensions, passlib, uvicorn, jinja2, pydantic==1.10.15, anyio, sniffio, idna, click, h11, python-multipart, annotated-types, annotated-doc
