...
def sanitize(text: str) -> str:
    """Replace non-ASCII characters with a closest ASCII equivalent or drop them."""
    # common replacements
    replacements = {
        '–': '-',
        '—': '-',
    ...
    # finally remove any remaining non-ASCII characters
...
def add_content(pdf, lines):
    ...
    for line in lines:
        ...
        if stripped.startswith('# '):
            ...
            pdf.cell(5)
            # Use a plain dash for bullet points (ASCII only)
